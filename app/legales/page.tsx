        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <section id="privacidad" className="mb-12">
            ...
            <Block title="2.3 Para qué los usamos">
              ...
              enviar notificaciones relativas al turno (por ejemplo, por WhatsApp) y administrar la suscripción
              de la Barbería. No usamos los datos para publicidad ni los vendemos a terceros.
            </Block>
