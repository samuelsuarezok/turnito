  ...
  return (
    <main className="min-h-screen bg-canvas flex items-center justify-center p-6">
      <motion.div className="text-center max-w-sm"
        ...
        <h1 className="text-xl font-extrabold text-ink mb-2">Esta página no existe</h1>
        ...
        <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="inline-block">
          <Link href="/"
            className="inline-block rounded-full bg-accent text-on-accent font-bold text-sm px-8 py-3.5">
            Ir al inicio →
          </Link>
        </motion.div>
      </motion.div>
